package com.example.wordcounter.constants;
...
public class WordCounterConstants {
    ...
    public static final String WORD_API= "api/word";
    public static final String ADD_WORDS = "/add";
    public static final String COUNT_WORD = "/count/{word}";
